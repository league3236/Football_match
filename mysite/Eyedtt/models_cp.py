...
class Ground(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'ground'
        unique_together = (('g_name', 'g_place'),)
...
class Point(models.Model):
    my_num = models.IntegerField(primary_key=True)
...
class Team(models.Model):
    ...
    t_call = models.CharField(max_length=15)
    ...
    t_password = models.CharField(max_length=1, blank=True, null=True)
